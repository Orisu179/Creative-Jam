    ...
    public static Dictionary<Mood, Dictionary<DrinkAttribute, string[]>> attr_hints = new()
    {
        { 
            Mood.happy, new() 
            {
                ...
                { DrinkAttribute.STRONG, new[] { "Hit me with your strongest. ", "I'm booked and busy today, so give me something strong! ", "Give it to me strong. " } },
                ...
                { DrinkAttribute.MILKY, new[] { "Do you have oat milk? Normal milk is fine if not. ", "With milk, please. ", "My body might be lactose intolerant, but my heart disagrees. " } }
            }
        },
        { 
            Mood.tired, new() 
            {
                { DrinkAttribute.FRUITY, new[] { "Something, like... fruity, [yawn], maybe... ", "Whatever fruit you have... ", "I think I need some Vitamin C... " } },
                ...
                { DrinkAttribute.MAGICAL, new[] { "Glitter? Sure, alright. I'll take all the help I can get... ", "By any chance do you know any necromancy? ", "Some of that... [waves claws vaguely], too....you know.. " } },
        ...
        { 
            Mood.sunny, new() 
            {
                ...
                { DrinkAttribute.STRONG, new[] { "Robust and full-bodied. ", "Extra strong. I want it to hit hard! ", "I'll take a double. "} },
                { DrinkAttribute.MAGICAL, new[] { "A little golden hour magic would be perfect. ", "Squeeze in some sunshine for me. ", "Give me something exciting. " } },
        ...
        { 
            Mood.chilly, new() 
            {
                ...
                { DrinkAttribute.SWEET, new[] { "Something indulgent. ", "Extra sweet. ", "With sugar. "} },
                ...
                { DrinkAttribute.MAGICAL, new[] { "Maybe some of that Christmas magic, if you have it already? ", "I want it to feel as special as watching the first snow fall. " } },
